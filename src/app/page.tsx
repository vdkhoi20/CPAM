      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto text-center">
         ...
         <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
          ...
          <a
            href="https://github.com/vdkhoi20/CPAM"
            target="_blank"
            rel="noopener noreferrer"
            className="px-6 py-2.5 bg-gray-900 hover:bg-black text-white rounded-lg font-semibold shadow-md transition-colors flex items-center gap-2"
          >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white rounded-lg p-6 border border-gray-200">
                ...
                <img
                  src={`${basePath}/Overall_Pipeline.png`}
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200">
                ...
                <img
                  src={`${basePath}/detail_mechanism.png`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="mt-4">
                <img src={`${basePath}/interface.png`} alt="iCONTRA Teaser" className="w-full h-auto rounded shadow-lg" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
              ...
              <div className="mt-4">
                <img src={`${basePath}/teaser_epedit.png`} alt="EPEdit Teaser" className="w-full h-auto rounded shadow-lg" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-300 shadow-md">
              ...
              <a
                href="https://vdkhoi20.github.io/PANDORA/"
                className="inline-block bg-blue-600 text-white px-5 py-2 rounded-lg font-semibold hover:bg-blue-700 transition"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <div className="mt-4">
                <img src={`${basePath}/teaser_Pandora.png`} alt="PANDORA Project Teaser" className="w-full h-auto rounded shadow-lg" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-300 shadow-md">
              ...
              <div className="mt-4">
                <img src={`${basePath}/teaser_focusdiff.png`} alt="FocusDiff Teaser" className="w-full h-auto rounded shadow-lg" />
              </div>
            </div>
          </div>
...
{`@article{vo2025cpam,
  ...
  year={2025}
            ...
            {/* FocusDiff Citation */}
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">FocusDiff (ICCCI 2026)</h3>
              <pre className="bg-white border border-gray-300 rounded p-4 overflow-x-auto text-sm font-mono text-gray-700">
{`@inproceedings{vo2026focusdiff,
  ...
  year={2026}
            ...
            {/* PANDORA Citation */}
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">PANDORA (ICME 2026)</h3>
              <pre className="bg-white border border-gray-300 rounded p-4 overflow-x-auto text-sm font-mono text-gray-700">
